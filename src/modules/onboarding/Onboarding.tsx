...
const Onboarding = () => {
  ...
  return createPortal(
    <Dialog open={true}>
      <DialogContent className="max-w-[100vw] w-screen h-screen m-0 p-0 rounded-none border-none flex flex-col bg-background" aria-describedby="xgn_modal_create_app">
        <div className="d-flex flex-column flex-root h-full" id="kt_app_root">
