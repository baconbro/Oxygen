...
const ProfileDetails = () => {
  ...
  const initialValues = {
    ...
    company: currentUser?.all.company ?? "",
    contactPhone: currentUser?.all.contactPhone ?? "",
    companySite: currentUser?.all.companySite ?? "",
    country: currentUser?.all.country ?? "",
    language: currentUser?.all.language ?? "",
    timeZone: currentUser?.all.timeZone ?? "",
    currency: currentUser?.all.currency ?? "",
    communications: {
      email: currentUser?.all?.communications?.email ?? false,
      phone: currentUser?.all?.communications?.phone ?? false,
    },
    allowMarketing: currentUser?.all.allowMarketing ?? false,
    workLocation: currentUser?.all.workLocation ?? "",
  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      <div
        ...
        data-bs-target='#xgn_account_profile_details'
        aria-expanded='true'
        aria-controls='xgn_account_profile_details'
      >
            ...
            <div className='row mb-6'>
              ...
              <div className='col-lg-8 fv-row'>
                ...
                {formik.touched.workLocation && formik.errors.workLocation && (
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'>{formik.errors.workLocation}</div>
                  </div>
                )}
              </div>
            </div>
